                    ...
                    <div class="col-12">
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0 border p-2 bg-danger">
                                    <%--                  <li class="breadcrumb-item"><a href="users?action=create">ADD</a></li>--%>
                                </ol>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:forEach items="${applicationScope.categoryList }" var="cate">
                                                    <c:if test="${cate.getId() == product.getCategory()}">
                                                        <c:out value="${cate.getName()}"/>
                                                    </c:if>
                                                </c:forEach>
                                            </td>
                                            <td colspan="2">
                                                ...
                                                <a href="products?action=create"
                                                   class="btn btn-outline-brown">Add</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
